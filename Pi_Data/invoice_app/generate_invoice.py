...
print(type(kdnr), type(startdatum), type(enddatum))
...
def generate_invoice(rechnung):
    # Template-Ordner setzen (hier aktuelles Verzeichnis)
    env = Environment(loader=FileSystemLoader("."))
    template = env.get_template("rechnung.html")
...
page_css = '''
    @page {
        ...
        @bottom-center {
            content: "Dipl.-Psych. Andreas Musterboy M.A., Beispiel Bank, DEXX XXXX XXXX XXXX XX; BIC XXXXXXX";
            font-size: 8pt;
            padding-top: 5px
        }
    }
